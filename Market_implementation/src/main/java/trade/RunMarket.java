...
public class RunMarket {
    public static void main(String[] args){
        ...
        log.info("Do you want to keep the data after session close? [yes/no]");
        String keepDataString = input.nextLine();

        boolean keepData = keepDataString.equalsIgnoreCase("yes");
